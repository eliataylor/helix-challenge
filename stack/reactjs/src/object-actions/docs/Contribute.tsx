    ...
    <Box>
      ...
      <StyledPaper>
        ...
        <Typography variant="body1" component={"li"} gutterBottom={true}>
          ...
          <a
            href="https://github.com/eliataylor/object-actions/blob/main/stack/django/helixai_app/permissions.py"
            target="_blank" rel="noreferrer"
          >
            stack/django/helixai_app/permissions.py
          </a>.
        </Typography>
        <Typography variant="body1" component={"li"} gutterBottom={true}>
        ...
        <Typography variant="body1" component={"li"} gutterBottom={true}>
          ...
          here{" "}
          <a
            href="https://github.com/eliataylor/objects-actions/blob/main/stack/django/helixai_base/settings/allauth.py"
            target="_blank" rel="noreferrer"
          >
            stack/django/helixai_base/settings/allauth.py
          </a>.
        </Typography>
      </StyledPaper>
