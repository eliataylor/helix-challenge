    ...
    <Box>
      ...
      <div style={{ marginTop: 50 }}>
        ...
        <StyledTypography variant="subtitle2">
          ...
          href={"https://github.com/eliataylor/objects-actions/blob/0fb527b9a8899cc5a5b42cf81d027b4b0a4a094f/stack/django/helixai_app/views.py#L117"}
          target="_blank" rel="noreferrer">stack/django/helixai_app/views.py#L117</a>
        </StyledTypography>
      </div>
