      ...
      <Grid item xs={12} sm={6} data-label={"DjangoAdmin"}>
        <Card variant="outlined">
          ...
          <Box sx={{ textAlign: "right", p: 1, alignContent: "flex-end" }}>
            <a
              href={
                "https://github.com/eliataylor/objects-actions/blob/main/stack/django/helixai_app/admin.py"
              }
              target="_blank" rel="noreferrer"
            >
              <TightButton
      ...
      <Grid item xs={12} sm={6} data-label={"DjangoDRF"}>
        <Card variant="outlined">
          ...
          <Box sx={{ textAlign: "right", p: 1, alignContent: "flex-end" }}>
            <a
              href={
                "https://github.com/eliataylor/objects-actions/blob/main/stack/django/helixai_app/urls.py"
              }
              target="_blank" rel="noreferrer"
            >
              <TightButton
