...
const defaultEnvConfig: EnvConfig = {
  PROJECT_NAME: process.env.REACT_APP_TITLE || "helixai",
  STACK_PATH: ".",
  TYPES_PATH: "src/examples/object-fields-demo.csv",
  PERMISSIONS_PATH: "src/examples/permissions-matrix-demo.csv",
  REACT_APP_API_HOST: process.env.REACT_APP_API_HOST || "https://localapi.helix.ai:8081",
  REACT_APP_APP_HOST: process.env.REACT_APP_APP_HOST || "https://localhost.helix.ai:3003",
  REACT_APP_LOGIN_EMAIL: process.env.REACT_APP_LOGIN_EMAIL || "info@localhost.helix.ai",
  REACT_APP_LOGIN_PASS: process.env.NODE_ENV === "development" ? process.env.REACT_APP_LOGIN_PASS || "HelixAI" : "HelixAI",
