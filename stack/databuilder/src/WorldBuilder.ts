import { FieldTypeDefinition, ModelName, ModelType, NavItem, NAVITEMS, TypeFieldSchema, Users } from "./types";
    ...
    for (const field of fields) {
      ...
      if (field.field_type === "id_auto_increment" || field.field_type === "slug") {
        ...
        if (mediaUrl) {
          ...
          console.log(`Fake image failed for ${field.machine}`);
        }
