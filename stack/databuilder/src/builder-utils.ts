    ...
    switch (field_type) {
        ...
        case 'email':
            ...
            try { // handle "The locale data for 'internet.emoji' are missing in this locale"
                ...
                email = `info-${new Date().getTime()}@localhost.helix.ai`
            }
            return email
        case 'phone':
            // @ts-ignore
        ...
        case 'url':
            ...
            try { // handle "The locale data for 'internet.emoji' are missing in this locale"
                ...
                iurl = `https://localhost.helix.ai:3003/test/${new Date().getTime()}`
            }
            return iurl
        case 'uuid':
        ...
        case 'image':
            ...
            // this returns empty image sometimes return imageMeta.rawFileUrl ? imageMeta.rawFileUrl : imageMeta.file;
        case 'video':
            const videoOpts = [
