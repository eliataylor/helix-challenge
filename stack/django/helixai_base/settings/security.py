...
DJANGO_SUPERUSER_EMAIL = myEnv('DJANGO_SUPERUSER_EMAIL', 'info@localhost.helix.ai')
...
DEV_PORT = '3003' if not APP_HOST_PARTS.port else APP_HOST_PARTS.port
...
CORS_ALLOWED_ORIGINS += [f"{APP_HOST_PARTS.scheme}://localhost:{DEV_PORT}",
                         ...
                         f"{APP_HOST_PARTS.scheme}://localhost.helix.ai:{DEV_PORT}",
                         f"{APP_HOST_PARTS.scheme}://reactjs-service:{DEV_PORT}",
                         f"{API_HOST_PARTS.scheme}://django-service:8081"]
