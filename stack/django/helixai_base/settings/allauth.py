...
APP_HOST = os.getenv('REACT_APP_APP_HOST', 'https://localhost.helix.ai:3003')
APP_HOST_PARTS = urlparse(APP_HOST)
API_HOST = os.getenv('REACT_APP_API_HOST', 'https://localapi.helix.ai:8081')
...
HEADLESS_ADAPTER = 'helixai_app.adapter.CustomHeadlessAdapter'
SOCIALACCOUNT_ADAPTER = 'helixai_app.adapter.MySocialAccountAdapter'

# SOCIALACCOUNT_TOKEN_STRATEGY = 'helixai_app.strategies.CustomTokenStrategy'
# ACCOUNT_ADAPTER = 'helixai_app.adapter.UserAdapter'
